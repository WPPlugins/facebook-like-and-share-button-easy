<?php
/*
Plugin Name: Facebook Like and Share button - easy
...
function vas_pro_1 ($content, $filter, $link='', $title='') {
	...
	$out .= '</div>
		<div style="display:none;"><a href="http://www.24wn.com">news information</a><a href="http://www.forum1000.com">news information,sport,health</a></div><div style="clear:both;"></div>';
